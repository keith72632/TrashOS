...
shell_funcs.o: utils/shell_funcs.c
	${CC} -c $^ -o $@ ${FLAGS}
os-image.bin: boot.o gdt.o idt_flush.o interrupts.o kernel.o drivers/display.o cpu/idt.o cpu/gdt.o cpu/isr.o timer.o common.o keyboard.o shell_funcs.o banner.o ${HEADERS}
